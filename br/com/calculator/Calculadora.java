...
public class Calculadora {
    ...
    void receberDados() {
        ...
        double numeroDeValoresConvertido = Double.parseDouble(numeroDeValores);
        double[] valores = new double[(int) numeroDeValoresConvertido];
        ...
        switch (x){
            case 0:
                ...
                operar.adicao(numeroDeValoresConvertido);
        }
    }
}
